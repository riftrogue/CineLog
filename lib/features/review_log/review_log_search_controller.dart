...
/// Controller for managing review log search state and functionality
class ReviewLogSearchController extends ChangeNotifier {
  ...
  /// Search for movies, TV shows, and people to log reviews for
  Future<void> search(String query) async {
    ...
    try {
      ...
      debugPrint('Review log search error: $e');
      _results = [];
    } finally {
      _setLoading(false);
    }
